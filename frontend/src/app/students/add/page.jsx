    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/students/add"
                className="bg-slate-600 hover:bg-slate-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 bg-slate-100"
              >
                Add Student
              </Link>
            </div>
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Fill in the details to add a new student to the system</p>
        </div>
